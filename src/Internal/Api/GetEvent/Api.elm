...
{-| Version 3 of the GetEvent API endpoint
-}
getEventV3 : GetEventInputV1 input -> A.TaskChain (PhantomV1 a) (PhantomV1 a)
getEventV3 { eventId, roomId } =
    A.request
        { attributes =
            [ R.accessToken
            , R.onStatusCode 404 "M_NOT_FOUND"
            ]
        , coder = getEventCoderV2
        , contextChange = always identity
        , method = "GET"
        , path = [ "_matrix", "client", "v3", "rooms", roomId, "event", eventId ]
        , toUpdate =
...
getEventCoderV2 : Json.Coder Event
getEventCoderV2 =
    Json.object8
        { name = "ClientEvent"
        , description =
        ...
        (Json.field.optional.value
            ...
            , coder =
                Json.object5
                    ...
                    , init = \a b c d e -> Event.UnsignedData { age = a, membership = b, prevContent = c, redactedBecause = d, transactionId = e }
                    }
                    (Json.field.optional.value
                        { fieldName = "age"
                        , toField = \(Event.UnsignedData data) -> data.age
                    ...
                    (Json.field.optional.value
                        ...
                        , toField = \(Event.UnsignedData data) -> data.membership
                        , description =
